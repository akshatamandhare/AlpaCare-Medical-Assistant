# """
# AlpaCare Medical Assistant - Training Script
# Complete training pipeline for fine-tuning Llama-2-7B-GPTQ with LoRA on medical data
# """
...
#         """Setup Llama-2 model and tokenizer with GPTQ quantization"""
...
#         # Load GPTQ model without bitsandbytes (Llama GPTQ has built-in quantization)
...
#         # Uncomment below ONLY if your source supports extra quantization config for LoRA training. Many GPTQ models already quantized, so do not pass BitsAndBytesConfig to them.
...
#     return {
#         "model_name": "TheBloke/Llama-2-7B-Chat-GPTQ",  # Llama GPTQ model
...
#             # Remove unsupported keys if getting errors:
...
"""
AlpaCare Medical Assistant - Training Script
Complete training pipeline for fine-tuning DistilGPT2 with LoRA on medical data
"""
